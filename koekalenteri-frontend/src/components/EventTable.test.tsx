...
test('It should render event dates', async function() {
  const event = { ...emptyEvent, startDate: new Date('2021-02-10'), endDate: new Date('2021-02-11'), isEntryOpen: false, isEntryClosing: false };
...
test('It should render registration link', async function() {
  const event = { ...emptyEvent, id: 'eventID', eventType: 'TestType', isEntryOpen: true, isEntryClosing: false };
